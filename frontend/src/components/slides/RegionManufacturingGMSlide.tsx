...
export default function RegionManufacturingGMSlide({ region, fy = "FY2027" }: { region: string; fy?: string }) {
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                console.error(`Failed to fetch manufacturing GM data for ${region}:`, err);
    ...
    // ── Visible accounts (filtered + sorted) ────────────────────────
        ...
        return [
            {
                ...
                textfont: { size: 14, color: '#1e3a5f', weight: 'bold' } as any,
                cliponaxis: false,
            ...
            },
            {
                ...
                textposition: 'outside' as const,
                textfont: { size: 14, color: '#2d8659', weight: 'bold' } as any,
                cliponaxis: false,
    ...
    if (loading) {
        return (
            <div style={{ backgroundColor: '#ffffff', height: '100%', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ fontSize: '1.25rem', fontWeight: 700, color: '#475569' }}>Loading manufacturing gross margin…</div>
            </div>
        );
    }
    if (error || !data) {
        return (
            <div style={{ backgroundColor: '#fef2f2', height: '100%', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
                <div style={{ textAlign: 'center', color: '#991b1b' }}>
                    <div style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.5rem' }}>Failed to load manufacturing gross margin</div>
                    <div>{error}</div>
                </div>
            </div>
        );
        ...
        <div style={{
            ...
            <div style={{ flex: 1, minHeight: 0, display: 'flex', gap: '0.5rem', overflow: 'hidden' }}>
                ...
                <div style={{ width: '55%', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                    ...
                    {/* "Show Data" buttons — one per category */}
                            ...
                            return (
                                <button
                                    ...
                                    style={{
                                        ...
                                        fontSize: '0.7rem',
                                        fontWeight: 600,
                                        border: `1px solid ${isActive ? '#1e3a5f' : '#94a3b8'}`,
                                        borderRadius: 4,
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', paddingTop: '0.15rem', flexShrink: 0 }}>
                        <LegendItem color={BAR_COLORS.revenue} label="Manufacturing Revenue" />
                        <LegendItem color={BAR_COLORS.gross_margin} label="Manufacturing Gross Margin" />
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    {/* Header for the right table section */}
                    <div style={{
                        ...
                        <button
                            ...
                            style={{
                                ...
                                fontSize: '0.65rem',
                                fontWeight: 600,
                                border: `1px solid ${filterAbove10K ? '#1e3a5f' : '#94a3b8'}`,
                                borderRadius: 4,
                                backgroundColor: filterAbove10K ? '#1e3a5f' : '#ffffff',
